...
final fetchAllSessionsByCodeProvider = StreamProvider.autoDispose
    .family<Iterable<Session>, String>((ref, programCode) {
  ...
  final streamSubscription = FirebaseFirestore.instance
      ...
      .where(SessionKey.programCode, arrayContains: programCode)
      .snapshots()
      .listen((snapshot) {

...
class AttendanceBySessionBarChart extends StatefulWidget {
  const AttendanceBySessionBarChart({super.key});
  ...
  @override
  State<StatefulWidget> createState() => AttendanceBySessionBarChartState();
}

class AttendanceBySessionBarChartState extends State<AttendanceBySessionBarChart> {

...
import 'package:student_attendance/presentation/module/student_module_body.dart';
import 'package:student_attendance/widgets/appbar.dart';


class ModuleUI extends StatelessWidget {
  static const String routeName = '/modules';

  static Route route() {
    return MaterialPageRoute(
      settings: const RouteSettings(name: routeName),
      builder: (_) => const ModuleUI(),
    );
  }

  const ModuleUI({Key? key}) : super(key: key);

...
class ModuleAverageAttendanceAPI {
  static Future<File> generate({
    ...
    pdf.addPage(pw.MultiPage(
      build: (context) => [
        buildHeader(module,attendance,sessions),
  ...
  static pw.Widget buildHeader(Module module,int attendance,int sessions) => pw.Column(
    ...
    children: [
      ...
      pw.Column(
        ...
        children: [
          ...
          pw.SizedBox(height: 2 * PdfPageFormat.cm),
          buildModuleStats(attendance,sessions),
        ],
      ),
    ],
  );
  ...
  static pw.Widget buildModuleStats(int totalAttendance,int sessions) {

    final Map<String,dynamic> data= {
      'total attendance':totalAttendance.toString(),
      'Completed Sessions': sessions.toString(),
  ...
  static pw.Widget buildInvoice(List<List<String>> attendance ) {
    var headers = ['Session', 'Attendance', 'Rate/session'];
